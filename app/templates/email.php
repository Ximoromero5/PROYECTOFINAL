                                                ...
                                                <tr>
                                                  <td valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tbody>
                                                        <tr>
                                                          <td valign="top" width="60"><img src="images/logo.png"
                                                            ...
                                                            <div class='contentEditableContainer contentTextEditable'>
                                                              <div class='contentEditable'
                                                                ...
                                                                <h1 class='big'><a target='_blank'
                                                                    ...
                                                                    style='color:#444444'>ximoromero</a></h1>
                                                              </div>
                                                            </div>
                                                          </td>
                                                        </tr>
                                                  ...
                                                  <td valign="middle" style='vertical-align: middle;' width='150'>
                                                    <div class='contentEditableContainer contentTextEditable'>
                                                      <div class='contentEditable' style='text-align: right;'>
                                                        <a target='_blank' href="[SHOWEMAIL]" class='link1'>Open in your
                                                          browser</a>
                                                      </div>
                                                    </div>
                                                  </td>
                                          ...
                                          <td valign="top" width="580">
                                            <div class='contentEditableContainer contentImageEditable'>
                                              <div class='contentEditable' style="text-align: center;"><img
                                                  class="banner" src="images/bigImg.png" alt="Logo" title="Logo"
                                                    ...
                                                    <div class='contentEditableContainer contentTextEditable'>
                                                      <div class='contentEditable' style='text-align: left;'>
                                                        ...
                                                        <a target='_blank' href="#" class='link2'
                                                          style='color:#ffffff'>Call to action</a>
                                                        <br>
                                                      </div>
                                                    </div>
                                                  </td>
                                                        ...
                                                        <td>
                                                          <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable' style='text-align: center;'>
                                                              ...
                                                              <br><br>
                                                              <a target='_blank' href="#" class='link3'
                                                                style='color:#555555;'>Call to action</a>
                                                              <br>
                                                            </div>
                                                          </div>
                                                        </td>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="specbundle" valign="top" width="142" align="center">
                                                    <div class='contentEditableContainer contentImageEditable'>
                                                      <div class='contentEditable'>
                                                        <img src="images/side.png" alt="side image" width='142'
                                                          ...
                                                          <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable' style='text-align: left;'>
                                                              ...
                                                              <p>Lorem Ipsum is simply dummy text of the printing and
                                                                ...
                                                                dummy text ever since the 1500s.</p>
                                                              <br>
                                                              <a target='_blank' href="#" class='link4'
                                                                style='color:#27A1E5;'>read more</a>
                                                            </div>
                                                          </div>
                                                        </td>
                                                      </tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td class="specbundle" valign="top" width="142" align="center">
                                                    <div class='contentEditableContainer contentImageEditable'>
                                                      <div class='contentEditable'>
                                                        <img src="images/side2.png" alt="side image" width='142'
                                                          height='142' data-default="placeholder" border="0">
                                                      </div>
                                                    </div>
                                                  </td>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="specbundle" valign="top" width="142" align="center">
                                                    <div class='contentEditableContainer contentImageEditable'>
                                                      <div class='contentEditable'>
                                                        <img src="images/side3.png" alt="side image" width='142'
                                                          height='142' data-default="placeholder" border="0">
                                                      </div>
                                                    </div>
                                                  </td>
                                                          ...
                                                          <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable'
                                                              ...
                                                              <p>
                                                                ...
                                                                [CLIENTS.ADDRESS] <br />
                                                                [CLIENTS.PHONE] <br />
                                                                <a target='_blank' href="[FORWARD]"
                                                                  style='color:#AAAAAA;'>Forward to a friend</a> <br />
                                                                <a target='_blank' href="[UNSUBSCRIBE]"
                                                      ...
                                                      <tr>
                                                          ...
                                                          <div class='contentEditableContainer contentFacebookEditable'>
                                                            <div class='contentEditable'
                                                              ...
                                                              <img src="images/facebook.png" alt="facebook" width='40'
                                                                height='40' data-max-width="40" data-customIcon="true"
                                                                border="0">
                                                            </div>
                                                          </div>
                                                        </td>
                                                        ...
                                                        <td width='40'>
                                                          <div class='contentEditableContainer contentImageEditable'>
                                                            <div class='contentEditable'
                                                              style='text-align: center;color:#AAAAAA;'>
                                                              <img src="images/red.png" alt="Pinterest" width='40'
                                                                height='40' data-max-width="40" border="0">
                                                            </div>
                                                          </div>
                                                        </td>
                                                        <td width='10'></td>
                                                        <td width='40'>
                                                          <div class='contentEditableContainer contentImageEditable'>
                                                            <div class='contentEditable'
                                                              style='text-align: center;color:#AAAAAA;'>
                                                              <img src="images/blue.png" alt="Social media" width='40'
                                                                height='40' data-max-width="40" border="0">
                                                            </div>
                                                          </div>
                                                        </td>
